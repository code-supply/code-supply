defmodule HostingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HostingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HostingWeb.Gettext, "errors", msg, opts)
    end
  end
