defmodule HostingWeb.UserSettingsLive do
  ...
  def render(assigns) do
    ...
    <div class="container">
      ...
      <.button id="delete-account" phx-click="delete_account">Yes, delete my account</.button>
    </div>
    """
  end
  ...
  def handle_event("delete_account", _params, socket) do
    user =
      socket.assigns.current_user
      |> Hosting.Repo.preload(sites: :domains)

    Accounts.delete_user(user)

    {:noreply,
     socket
     |> redirect(external: url(~p"/"))}
  end
end
