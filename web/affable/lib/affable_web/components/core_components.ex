defmodule AffableWeb.CoreComponents do
  @moduledoc """
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 btn btn-spaced",
        @class
      ]}
      {@rest}
    >
  ...
  def input(%{type: "checkbox", value: value} = assigns) do
    ...
    <div class="pt-4" phx-feedback-for={@name}>
      ...
      <input
        ...
        value="true"
        checked={@checked}
        class="rounded focus:ring-zinc-900"
        {@rest}
      />
      <label class="pl-1" for={@id || @name}>
        <%= @label %>
      </label>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AffableWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AffableWeb.Gettext, "errors", msg, opts)
    end
  end
