defmodule Affable.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Affable.Repo)
  ...
  """
  def valid_password?(%Affable.Accounts.User{hashed_password: hashed_password}, password)
